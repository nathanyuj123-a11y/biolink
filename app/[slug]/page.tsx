      ...
      <main className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-[440px] flex-col justify-center px-5 py-8">
        ...
        <div className="mt-3 space-y-2.5">
          {store.google_review_url && (
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" className="justify-self-center text-sared" fill="currentColor">
          ...
          >
            <svg width="22" height="22" viewBox="0 0 24 24" className="justify-self-center text-emerald-600" fill="currentColor">
          ...
          >
            <svg width="22" height="22" viewBox="0 0 24 24" className="justify-self-center text-sky-600" fill="none" stroke="currentColor" strokeWidth="2">
